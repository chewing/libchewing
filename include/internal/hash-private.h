...
#define CHEWING_DB_CONFIG_SEL_ID	(0)
#define CHEWING_DB_CONFIG_SEL_VALUE	(1)

#define CHEWING_DB_CONFIG_INS_ID	(CHEWING_DB_CONFIG_SEL_ID + 1)
#define CHEWING_DB_CONFIG_INS_VALUE	(CHEWING_DB_CONFIG_SEL_VALUE + 1)

#define CHEWING_DB_CONFIG_SELECT "SELECT " CHEWING_TABLE_CONFIG " FROM (id, value) " \
	"WHERE id = ?1"
