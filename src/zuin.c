...
static int EndKeyProcess(ChewingData *pgdata, int key, int searchTimes)
{
    ...
    if (pZuin->pho_inx[0] == 0 && pZuin->pho_inx[1] == 0 && pZuin->pho_inx[2] == 0 && pZuin->pho_inx[3] == 0) {
        /*
    ...
    if (pZuin->pho_inx_alt[0] == 0 && pZuin->pho_inx_alt[1] == 0 && pZuin->pho_inx_alt[2] == 0) {
...
static int HsuPhoInput(ChewingData *pgdata, int key)
{
    ...
    if (IsHsuPhoEndKey(pZuin->pho_inx, key)) {
        ...
        if ((pZuin->pho_inx[0] == 9) && ((pZuin->pho_inx[1] == 1) || (pZuin->pho_inx[1] == 3))) {
            pZuin->pho_inx[0] = 12;
        }
        ...
        if (type == 1 && inx == 2 && 12 <= pZuin->pho_inx[0] && pZuin->pho_inx[0] <= 14) {
            pZuin->pho_inx[0] += 3;
        }
        ...
        /* ㄐㄑㄒ must follow ㄧㄩ */
        if (type == 2 && pZuin->pho_inx[1] == 0 && 12 <= pZuin->pho_inx[0] && pZuin->pho_inx[0] <= 14) {
            pZuin->pho_inx[0] += 3;
        }
...
static int ET26PhoInput(ChewingData *pgdata, int key)
{
    ...
    if (IsET26PhoEndKey(pZuin->pho_inx, key)) {
        ...
        if (type == 2 && pZuin->pho_inx[1] == 0 && (pZuin->pho_inx[0] == 12 || pZuin->pho_inx[0] == 14)) {
            pZuin->pho_inx[0] += 3;
        }
...
static int PinYinInput(ChewingData *pgdata, int key)
{
    ...
    if (IsPinYinEndKey(key)) {
        err = PinyinToZuin(pgdata, pZuin->pinYinData.keySeq, zuinKeySeq, zuinKeySeqAlt);
        if (err) {
        ...
        for (i = 0; i < len; i++) {
            ...
            for (type = 0; type <= 3; type++) {
                inx = PhoneInxFromKey(zuinKeySeq[i], type, pZuin->kbtype, 1);
                if (inx)
                    break;
            }
        ...
        for (i = 0; i < len; i++) {
            ...
            for (type = 0; type <= 3; type++) {
                inx = PhoneInxFromKey(zuinKeySeqAlt[i], type, pZuin->kbtype, 1);
                if (inx)
                    break;
            }
